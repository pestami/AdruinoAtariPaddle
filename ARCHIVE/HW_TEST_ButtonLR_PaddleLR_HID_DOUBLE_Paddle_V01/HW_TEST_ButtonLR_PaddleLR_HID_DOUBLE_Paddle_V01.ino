...
void sendtoserial(bool bDEBUG) {
  ...
  Serial.print(" A1:" + Button_State_LEFT );
  Serial.print(" A2:" +  Button_State_RIGHT );

  Serial.print(" SEL:" + State_Button_SEL );
  Serial.print(" STA:" +  State_Button_STA );

  Serial.print(" X:" +  State_Button_X);
  Serial.print(" Y:" + State_Button_Y );
  Serial.print(" H:" + State_Button_H );
  Serial.print(" MODE:" +  State_Button_FLAG );
