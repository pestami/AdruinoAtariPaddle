...
int State_Button_A_LEFT= 0;  
int State_Button_A_RIGHT = 0;
...
long nJoystickRight = 0;  //nJoystickRight
long nJoystickLeft = 0;
...
void sendtoserial(bool bDEBUG) 
{
  Serial.print("\n========BUTTON====================================================================================================\n");
  Serial.print("LEFT:");
  Serial.print(State_Button_A_LEFT);
  Serial.print("   RIGHT:");
  Serial.print(State_Button_A_RIGHT);

  Serial.print("   nJoystickRight:");
  Serial.print(nJoystickRight);
  Serial.print("   nJoystickLeft:");
  Serial.print(nJoystickLeft);
  ...
  Serial.print(" A1:" + String(State_Button_A_LEFT) );
  Serial.print(" A2:" +  String(State_Button_A_RIGHT ));
...
void loop() 
{
  ...
  State_Button_A_LEFT= digitalRead(BUTTON_LEFT_A); 
  State_Button_A_RIGHT = digitalRead(BUTTON_RIGHT_A);
...
//==================================================================
// PADDLES
// Send JOYSTICK to USB
//==================================================================
  if (State_Button_A_LEFT== HIGH) 
        {
  ...
  else {Joystick[1].setButton(0, 0);}
//------------------------------------------------------------------
   if (State_Button_A_RIGHT == HIGH) 
        {
...
//==================================================================
 ...
 nJoystickRight=(-nJOY_Range+nLoadRIGHT*nJOY_Range/50);
 nJoystickLeft=(-nJOY_Range+nLoadLEFT*nJOY_Range/50);  // 50 = 100 / 2


  Joystick[0].setXAxis( 1 * nJoystickRight);
  Joystick[1].setXAxis(1 * nJoystickLeft);
